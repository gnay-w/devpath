...
- **已完成讲解：** [0101 包与可见性](./notes/kp/0101-packages-visibility/) · [0102 类型与零值](./notes/kp/0102-types-zero-values/) · [0103 指针基础](./notes/kp/0103-pointers/) · [0104 逃逸分析](./notes/kp/0104-escape-analysis/)
- Lab：暂无
- 项目：暂无（P3：`projects/json-api/`）

## 下一步

1. 当前 **0105**：互动教学（先教后写 KP；demo 助手跑）
2. 按编号继续，不跳号
